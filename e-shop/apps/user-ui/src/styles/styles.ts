...
const styles = {
  input:
    'w-full  py-2 px-5  border border-none outline-none bg-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-slate-300 transition duration-200 ease-in-out backdrop-blur-md !rounded-full',
  searchIoncs: `${
