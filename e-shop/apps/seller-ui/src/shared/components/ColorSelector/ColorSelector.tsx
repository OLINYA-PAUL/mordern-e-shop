...
// //                       onChange(
// //                         isSelected
// //                           ? value.filter((c: string) => c !== color)
// //                           : [...(value || []), color]
// //                       )
// //                     }
// //                     className={`w-7 h-7 rounded-full border-2 border-slate-600 my-1 flex items-center justify-center relative ${
// //                       isSelected
// //                         ? 'translate-x-0 hover:scale-110 transition-all duration-200 ease-in-out'
// //                         : 'border-transparent'
// //                     } ${
// //                       isLightColor
// //                         ? 'translate-x-0 hover:scale-110 transition-all duration-200 ease-in-out'
...
// //                         ? '0 0 0 2px rgba(255, 255, 255, 0.5), 0 0 0 4px rgba(0, 0, 0, 0.2)'
// //                         : 'none',
...
// //                       <Pickaxe
// //                         size={10}
// //                         color={isLightColor ? `${color}` : 'white'}
// //                       />
// //                     )}
// //                   </button>
// //                 </>
...
// //             <button
// //               type="button"
// //               className={`w-7 h-7 rounded-full border-2 border-slate-600 my-1 flex items-center justify-center relative cursor-pointer `}
// //             >
...
// //                 className="w-10 h-10 rounded-full  border-0 my-1 cursor-pointer"
// //               />

// //               <button
// //                 type="button"
// //                 className="px-3 py-1 bg-gray-700 text-white rounded-md text-xs"
// //                 onClick={() => {
// //                   setcustomeColor([...customeColor, newColor]);
// //                   setshowColorPicker(false);
// //                 }}
// //               >
// //                 Add <Plus size={10} color={'white'} />
// //               </button>
// //             </div>
// //           </div>
// //         )}
