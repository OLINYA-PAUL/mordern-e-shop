...
const SignUp = () => {
  ...
  return (
    <div className=" w-full flex flex-col items-center min-h-screen mt-10 ">
      <div className="relative w-full md:w-[50%]  mx-auto flex items-center justify-between mb-8">
        <div className="absolute top-[20px] left-0 right-0 h-1 bg-slate-400 -z-10 rounded-md" />

        {[1, 2, 3].map((steps) => {
          const isActive = steps === activeStep;
          ...
          return (
            ...
            >
              <div
                className={`w-[40px] h-[40px] rounded-full flex items-center justify-center font-poppins text-lg ${
      ...
      <div className="min-h-screen w-full m.x-auto bg-[#fcfcf3] flex items-center flex-1 flex-col h-auto justify-center p-6 ">
